...
function progressControlGetStatus() {
  ...
  //$('.stepsCheckBox').empty();
  var customCheckCompleted = '<input type="checkbox" class="filled-in stepsBox" id="filled-in-box" checked="checked" /><label for="filled-in-box">Step Completed</label><div class="footerNext"><a class="footerNextbtn"><i class="material-icons flash_2">&#xE5CC</i></a></div>';
